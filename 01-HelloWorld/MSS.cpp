...
int quadratic_mss(const int* arr, int length) {
...
int cubic_mss(const int* arr, int length) {
...
int linear_mss(const int* arr, int length) {    
    int maxSum = 0;
    int thisSum = 0;
    for(int i = 0; i < length; i++) {
